 ...
 * @author magictool
 */
public class ChooseFolderMyText implements EventHandler<MouseEvent> {
    ...
    public ChooseFolderMyText(MyTextField eTextField, String title, String startPath, String fileType) {
    ...
    public ChooseFolderMyText(MyTextField eTextField, String title, String startPath) {
        this.eTextField = eTextField;
        this.title = title;
        this.startPath = startPath;
    }
