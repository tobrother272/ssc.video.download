 ...
 * @author magictool
 */
public class ChooseFileMyText implements EventHandler<MouseEvent> {
     ...
     */ 
    public MyTextField eTextField;
    public String title;
    public FileChooser.ExtensionFilter[] arrFilter;
    private String namePreSave;

    public ChooseFileMyText(MyTextField eTextField, String title, String startPath, FileChooser.ExtensionFilter[] arrFilter, String namePreSave) {
    ...
    public ChooseFileMyText(MyTextField eTextField, String title, String startPath) {
        this.eTextField = eTextField;
        this.title = title;
        this.startPath = startPath;
    }
