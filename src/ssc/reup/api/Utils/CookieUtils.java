...
public class CookieUtils {
    ...
    public static void saveCookies(String folder) {
        try {
            ...
            Files.write(Paths.get(folder+"\\cookies.json"), json.getBytes(StandardCharsets.UTF_8));
        } catch (Exception e) {
            //e.printStackTrace();
        }
    }
    
    public static void loadCookies(String folder) {
        try {
            byte[] bytes = Files.readAllBytes(Paths.get(folder+"\\cookies.json"));
